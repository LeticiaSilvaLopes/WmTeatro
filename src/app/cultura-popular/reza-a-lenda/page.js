...
export default function RezaALenda() {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed mb-8">
              Na floresta amazônica, dois piratas chegam em busca de capturar o Saci, mas encontram resistência mágica: Curupica, Yara e Boitatá se unem para defender a mata e proteger as lendas que nela vivem. Uma aventura teatral que mistura fantasia, folclore e preservação cultural.
            </p>
