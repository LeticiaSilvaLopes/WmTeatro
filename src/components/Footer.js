...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-purple-800 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center space-y-6">
          ...
          >
            <div className="flex flex-col sm:flex-row sm:justify-center sm:space-x-8 space-y-2 sm:space-y-0 text-gray-300">
              <div className="flex items-center justify-center">
                <span className="text-purple-400 mr-2">📧</span>
                <span>wmteatro@gmail.com</span>
              </div>
              <div className="flex items-center justify-center">
                <span className="text-purple-400 mr-2">📱</span>
                <span>(13) 99642-1728</span>
              </div>
            </div>
          </motion.div>
          ...
          {/* Copyright */}
          <motion.div
            className="text-center pt-4 border-t border-gray-800 w-full"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
