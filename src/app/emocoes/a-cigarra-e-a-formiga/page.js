...
export default function ACigarraEAFormiga() {
  ...
  const mediaItems = [
    {
      type: 'video',
      videoSrc: '/videos/CigarraEAFormiga.mp4',
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed mb-8">
              A diferença entre duas atitudes diante da vida: A da cigarra com as suas canções, e a da formiga, que trabalha duro para guardar comida para o inverno. Quando chega a época de frio e fome, a cigarra pede ajuda à formiga, o que será que irá acontecer? 
</p>
<p className="text-xl text-gray-300 leading-relaxed mb-8">
Uma história que fala de organização, respeito e empatia. E que irá te surpreender com muitas informações e humor.
            </p>
