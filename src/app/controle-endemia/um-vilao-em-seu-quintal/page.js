    ...
    <div className="min-h-screen bg-black text-white">
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.h1 
            className="text-5xl md:text-7xl font-bold mb-8 bg-gradient-to-r from-gray-700 via-white via-gray-600 via-gray-200 to-gray-800 bg-clip-text text-transparent leading-tight"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            UM VILÃO EM SEU QUINTAL
          </motion.h1>
        </div>
      </motion.section>
