...
export default function CoracaoDeTinta() {
  ...
  const mediaItems = [
    {
      type: 'video',
      videoSrc: '/videos/CoracaoDeTinta.mp4',
      alt: 'Vídeo do espetáculo 1'
    },
    {
      type: 'image',
      src: '/images/CoracaoDeTinta1.jpg',
      alt: 'Cena do espetáculo 1'
    },
    {
      type: 'image',
      src: '/images/CoracaoDeTinta2.jpg',
      alt: 'Cena do espetáculo 2'
    },
    {
      type: 'image',
      src: '/images/CoracaoDeTinta3.jpg',
      alt: 'Cena do espetáculo 3'
    },
    {
      type: 'image',
      src: '/images/CoracaoDeTinta4.jpg',
      alt: 'Cena do espetáculo 4'
    },
    {
      type: 'image',
      src: '/images/CoracaoDeTinta5.jpg',
      alt: 'Cena do espetáculo 5'
    },
    {
      type: 'image',
      src: '/images/CoracaoDeTinta6.jpg',
      alt: 'Cena do espetáculo 6'
    },
    {
      type: 'image',
      src: '/images/CoracaoDeTinta7.jpg',
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed mb-8">
             Aninha troca jogos eletrônicos por livros mágicos e descobre o poder transformador da leitura.
            </p>
